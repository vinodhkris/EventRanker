...
./configure --prefix=%{_prefix} --with-etcsgml=%{sysconfdir} --datadir=%{_datadir} --mandir=%{_mandir} --with-dbimages=%{_datadir}/sgml/docbook/dsssl-stylesheets/images/
make
...
* Fri Jun 30 2000 Marc André Selig <mas@seligma.com>
- prepared for 3.0.2
- removed patch for catalogue file, which now comes with the source

* Sun Jun 25 2000 Marc André Selig <mas@seligma.com>
...
* Thu Jun 15 2000 Marc André Selig <mas@seligma.com>
